...
imgTiles["="] = love.graphics.newImage("_ressources_/images/tile=.png")
imgTiles["["] = love.graphics.newImage("_ressources_/images/tile[.png")
imgTiles["]"] = love.graphics.newImage("_ressources_/images/tile].png")
imgTiles["H"] = love.graphics.newImage("_ressources_/images/tileH.png")
imgTiles["#"] = love.graphics.newImage("_ressources_/images/tile#.png")
imgTiles["g"] = love.graphics.newImage("_ressources_/images/tileg.png")
imgTiles[">"] = love.graphics.newImage("_ressources_/images/tile-arrow-right.png")
imgTiles["<"] = love.graphics.newImage("_ressources_/images/tile-arrow-left.png")
...
function ChargeNiveau(pNum)
  ...
  currentLevel = pNum
  map = {}
  local filename = "_ressources_/levels/level"..tostring(pNum)..".txt"
...
function CreatePlayer(pCol, pLig)
  ...
  myPlayer.AddAnimation("_ressources_/images/player", "idle", { "idle1", "idle2", "idle3", "idle4" })
  myPlayer.AddAnimation("_ressources_/images/player", "run", { "run1", "run2", "run3", "run4", "run5", "run6", "run7", "run8", "run9", "run10" })
  myPlayer.AddAnimation("_ressources_/images/player", "climb", { "climb1", "climb2" })
  myPlayer.AddAnimation("_ressources_/images/player", "climb_idle", { "climb1" })
...
function CreateCoin(pCol, pLig)
  ...
  myCoin.AddAnimation("_ressources_/images/coin", "idle", { "coin1", "coin2", "coin3", "coin4" })
  myCoin.PlayAnimation("idle")
end

function CreateDoor(pCol, pLig)
  local myDoor = CreateSprite("door", (pCol-1) * TILESIZE, (pLig-1) * TILESIZE)
  myDoor.AddAnimation("_ressources_/images/door", "close", { "door-close" })
  myDoor.AddAnimation("_ressources_/images/door", "open", { "door-open" })
  myDoor.PlayAnimation("close")
end

function CreatePNJ(pCol, pLig)
  local myPNJ = CreateSprite("PNJ", (pCol-1) * TILESIZE, (pLig-1) * TILESIZE)
  myPNJ.AddAnimation("_ressources_/images/pnj", "walk", { "walk0", "walk1", "walk2", "walk3", "walk4", "walk5" })
